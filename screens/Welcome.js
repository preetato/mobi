...
import {Avatar,WelcomeImage,PageTitle,SubTitle,StyledFormArea,StyledButton,StyledButtonn,InnerContainer,WelcomeContainer,ButtonText,Line,Colors,} from './../components/styles';
        ...
        <>
            ...
            <InnerContainer>
                ...
                <SubTitle welcome={true}>Welcome!</SubTitle>
                    <StyledFormArea>
                    <Avatar resizeMode="cover" source={require('./../assets/img/tricycle.png')} />
